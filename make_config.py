...
if __name__ == '__main__':
    ...
    p.add_argument('-dmod', '--d_model', type=int, default=512, help='Transformer hidden size')
    ...
    model2args = {
        's2s': common_params + ['hidden_size'],
        's2s_attn': common_params + ['hidden_size', 'attention'],
        'transformer': common_params + ['src_vocab_size', 'tgt_vocab_size', 'd_model', 'num_heads',
