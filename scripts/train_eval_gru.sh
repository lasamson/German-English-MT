# Setup some hyperparametess for the GRU Seq2Seq Baseline Model
...
python translate.py -data_path=$data_path -model_dir=$model_dir -model_file="best.pth.tar" -greedy -beam_size=$beam_size
