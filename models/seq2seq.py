...
class EncoderDecoder(nn.Module):
    ...
    def decode(self, trg, encoder_outputs, src_mask, tgt_mask, encoder_final=None, decoder_hidden=None):
        """ 
        ...
        Returns:
            A Tensor of shape [batch_size, seq_len, hidden_size]
        """
        return self.decoder(trg, encoder_outputs, src_mask, tgt_mask, encoder_final, hidden=decoder_hidden)
...
def make_seq2seq_model(params):
    ...
    generator = nn.Linear(params.hidden_size, params.tgt_vocab_size, bias=False) 
